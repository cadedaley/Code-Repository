...
$copy = Read-host "Enter the UserID of the User you wish to Copy Groups From"
$paste = Read-host "Enter the UserID of the User you wish to Add Groups To"
...
Write-Host "Import Completed! Closing in 10 Seconds." -ForegroundColor Green
